...
const dataFilePath = path_1.default.join(sheetsDir, "data.xlsx");
/**
...
if (!fs_1.default.existsSync(dataFilePath)) {
    ...
    xlsx_1.default.writeFile(wb, dataFilePath);
...
async function createUserData(email) {
    ...
    const workbook = xlsx_1.default.readFile(dataFilePath);
    ...
    xlsx_1.default.utils.book_append_sheet(workbook, worksheet, email);
    xlsx_1.default.writeFile(workbook, dataFilePath);
